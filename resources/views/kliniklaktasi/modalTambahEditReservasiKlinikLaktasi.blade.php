<div class="modal fade" id="modalTambahEditReservasiKlinikLaktasi" tabindex="-1" role="dialog" aria-labelledby="modalTambahEditReservasiKlinikLaktasi" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title">Tambah Data Reservasi Klinik Laktasi</h5>
      ...
      <div class="modal-body">
        ...
        {!! Form::open(array('class' => "needs_validation", 'novalidate', 'id'=>'editTambahReservasiKlinikLaktasi')) !!}
          <div class="row">
            <div class="form-group col-xs-12">
              {!! Form::label('slugKlinikLaktasi','Slug',array('style'=>'display:none')) !!}
              {!! Form::text('slugKlinikLaktasi','',array('style' => 'display:none')) !!}
            ...
            <div class="form-group col-xs-12 col-md-6 timepicker">
              ...
              {!! Form::text('pukul_reservasi_awal','',array("class" => "form-control form-control-sm", "placeholder" => "Masukan Pukul Reservasi", "required" ))!!}
          ...
          <div class="text-right">
            <button type="submit" name="1" class="btn btn-primary"><span class="fa fa-save"></span> Simpan</button>
            <button type="button" name="2" class="btn btn-secondary" data-dismiss="modal"><span class="fa fa-ban"></span> Batal</button>
          </div>
        {!! Form::close() !!}
      </div>
    </div>
