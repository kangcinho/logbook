    ...
    <table class='textKecil'>
      <thead>
        ...
        <tr>
          ...
          <th class="widthTambahan">Alamat Pasien</th>
          <th>Telpon Pasien</th>
          <th>Tanggal Lahir Pasien</th>
          <th class="widthTambahan">Keterangan/Request</th>
        </tr>
      </thead>
      ...
      <tbody>
        ...
        @foreach($reservasies as $reservasi)
          <tr>
            ...
            <td class="rataTengah" class="widthTambahan">{!! $reservasi->nama_pasien !!}</td>
            <td class="rataTengah" class="widthTambahan">{!! $reservasi->alamat_pasien !!}</td>
            <td class="rataTengah">{!! $reservasi->tlp_pasien !!}</td>
            <td class="rataTengah">{!! tanggal($reservasi->tgl_lahir_pasien) !!}</td>
            <td class="rataTengah" class="widthTambahan">{!! $reservasi->keterangan !!}</td>
          </tr>
        @endforeach
      </tbody>
    </table>
