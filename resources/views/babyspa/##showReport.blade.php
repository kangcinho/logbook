  ...
  function sweetTable(){
    var dataTable = $('#tabelReservasiBabySPA').DataTable({
      ...
      buttons: [{
        ...
        title: 'Data Reservasi Baby SPA',
        title: function(){
          return '<small> Data Reservasi Baby SPA '+ tanggal($('div.toolbar #searchRangeCheckInCheckOut1').val()) +"-"+ tanggal($('div.toolbar #searchRangeCheckInCheckOut2').val())+"</small>";
        },
        exportOptions: {
  ...
  function showTabeldataReservasiBabySPA(){
    $.ajax({
      ...
      success:function(data){
        ...
        var data1 = '\
        <table class="table table-striped table-bordered table-sm small" id="tabelReservasiBabySPA" cellspacing="0" width="100%"> \
          <thead class="bg-light">\
            <tr>\
              <th class="col-xs-1 text-center customTableResponsive">Tgl Reservasi</th>\
              <th class="col-xs-1 text-center customTableResponsive">Pukul Reservasi</th>\
              ...
              <th class="col-xs-2 text-center customTableResponsive">Alamat</th>\
              <th class="col-xs-1 text-center customTableResponsive">Tlp</th>\
